...
public class TransferDAO extends AbstractDAO {
	...
	public List<Map<String, Object>> getPlayerList(String key) {
		// TODO Auto-generated method stub
		return (List<Map<String, Object>>)selectList("transfer.getPlayerList", key);
	}

	public void dropTempPlayer(int appear) {
		// TODO Auto-generated method stub
		delete("transfer.dropTempPlayer", appear);
	}
	...
	public void removeTempUserKey(String key) {
		// TODO Auto-generated method stub
		update("transfer.removeTempUserKey", key);
	}
